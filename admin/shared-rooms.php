...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h1 class="h2"><i class="bi bi-gear-fill"></i>Shared Rooms</h1>
      </div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-md">
          ...
          <?php 
             ...
             LEFT JOIN tbl_student ON tbl_student.id=tbl_room.Student_id where tbl_room.room_category_id=2";
          ...
          <tbody>
            ...
            <?php
                if($student_id == NULL && $status == "Available")
                {
                    ?><a href="<?php echo SITEURL;?>admin/vacant-student.php?id=<?php echo $room_id;?>" class="btn btn-md btn-outline-success">Vacant</a></td>
                    <?php
                }
                else if($student_id == NULL && $status == "Maintenance")
                {
                    ?><button  class="btn btn-md btn-outline-dark">Maintenance</button>
