...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h1 class="h2"><i class="bi bi-gear-fill"></i>Allocate Student</h1>
      </div>
...
<?php
             if(isset($_POST['submit']))
             {
                 ...
                 if($res2==TRUE)
                 {
                     ...
                     $_SESSION['room-allocate'] = "<div class='alert alert-success'><strong>Room Allocated Successfully.!</strong></div>";
                 ...
                 else
                 {
                     ...
                     $_SESSION['room-allocate'] = "<div class='alert alert-danger'><strong>Failed to Allocated Room.!</strong></div>";
