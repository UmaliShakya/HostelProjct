...
<?php
       ...
       // $student_id = $_GET['student_id'];
        ...
        $sql = " SELECT * FROM tbl_monthly_payment ORDER BY payment_id DESC LIMIT 1";
        //Execute the Query
      ...
      <div class="row w-50 h-50  pt-4  mx-auto" id="setting">
            <div class="shadow-sm p-4 mb-4 bg-light border  "  id="cat">
                ...
                <div class="col-sm-5">
                  ...
                  <h5 class="">Student ID</h5>
                  <h5 class="">Room No</h5>
                  <h5 class="">Year</h5>
                  <h5 class="">Month </h5>
                  <h5 class="">Monthly Payment </h5>
                  <h5 class="">Payment Date</h5>

                </div>
                
                <div class="col-sm-6">
                  <h5 class="">: <?php echo $payment_id;?></h5>
                  <h5 class="">: <?php echo $student_id;?></h5>
                  <h5 class="">: <?php echo $room_no;?></h5>
